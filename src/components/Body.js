...
import ErrorFetchAPI from "./ErrorFetchAPI";
...
export let Body = () => {
    ...
    // let restList = dataJson?.data?.data?.cards[4]?.card?.card?.gridElements?.infoWithStyle?.restaurants;
